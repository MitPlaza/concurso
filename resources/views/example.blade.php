<x-guest-layout>
    <div class="w-full">
        <div class="w-full">
            <!-- Imagen para desktop (se oculta en móviles) -->
            <img class="h-auto w-full hidden md:block" src="/images/Banner-Mantita-Cumple-Mes.jpg" alt="Banner Desktop">

            <!-- Imagen para móviles (se oculta en escritorio) -->
            <img class="h-auto w-full block md:hidden" src="/images/Banner-Mantita-Cumple-Mes-mobile.jpg"
                alt="Banner Mobile">
        </div>
                ...
                <div class="py-8 px-4 mx-auto  text-center lg:py-6">
                    ...
                    <ul class="mb-8 text-lg text-left p-8 border rounded-2xl text-gray-600 bg-opacity-80 bg-gray-100 list-inside "
                        ...
                        <li class="flex items-baseline">
                            ...
                            Toma una foto cada cumple mes de tu bebé sobre la Mantita destacando el mes
            ...
            <div class="mx-auto" style="max-width: 800px;">
                ...
                <form action="{{ route('participantes.store')}}" class="p-8" method="post" enctype="multipart/form-data"
                    ...
                    <div class="col-span-full">
                        <label for="cover-photo" class="block text-sm/6 font-medium text-gray-900">Foto de tu
                            bebé</label>
                        <div
